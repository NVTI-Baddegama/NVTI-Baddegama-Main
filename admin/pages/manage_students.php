...
<script>
    ...
    function exportPDF() {
        ...
        <?php if ($filter_course): ?>
        doc.text('Course Filter: <?php echo addslashes($filter_course); ?>', 20, 40);
        <?php endif; ?>
        <?php if ($search_nic): ?>
        doc.text('NIC Search: <?php echo addslashes($search_nic); ?>', 20, <?php echo $filter_course ? 45 : 40; ?>);
        <?php endif; ?>
        ...
        doc.autoTable({
            ...
            body: tableData,
            startY: <?php echo ($filter_course && $search_nic) ? 55 : ($filter_course || $search_nic ? 50 : 45); ?>,
            styles: { fontSize: 7 },
