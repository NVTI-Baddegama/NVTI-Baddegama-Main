...
<body class="bg-gray-100 min-h-screen">
    ...
    <header
        class="fixed top-0 left-0 right-0 h-16 bg-white shadow-md z-30 flex items-center justify-between px-4 transition-all duration-300"
        id="page-header">
        ...
        <div class="flex items-center space-x-4 relative"> <button
                class="relative p-2 text-gray-600 hover:text-green-600 transition duration-150 rounded-full hover:bg-gray-100">
                <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                    xmlns="http://www.w3.org/2000/svg">
...
<?php } ?>
                ...
                <svg class="w-5 h-5 text-gray-400 group-hover:text-gray-600 transition duration-150" fill="none"
    ...
    <div id="sidebar-wrapper">
        <nav class="fixed top-0 bottom-0 left-0 w-64 bg-slate-800 text-white z-40 transform -translate-x-full lg:translate-x-0 transition-transform duration-300 ease-in-out shadow-2xl"
            id="page-sidebar">
            <div class="h-16 bg-slate-900 flex items-center justify-between px-4">
                ...
                <label for="sidebar-toggle"
                    class="p-2 cursor-pointer text-white hover:bg-white/10 rounded-full transition duration-150 lg:hidden">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                        xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="px-4 space-y-2 h-full overflow-y-auto pt-4 pb-16">
                <div class="space-y-1">
                    <a href="Dashboard.php"
                        class="flex items-center p-3 text-sm font-semibold rounded-lg text-gray-300 hover:bg-slate-700 hover:text-white transition duration-150">
                    ...
                    <a href="student_register.php"
                        class="flex items-center p-3 text-sm font-medium rounded-lg text-gray-300 hover:bg-slate-700 hover:text-white transition duration-150">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                            xmlns="http://www.w3.org/2000/svg">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M18 9v3m0 0v3m0-3h3m-3 0h-3m-2-5a4 4 0 11-8 0 4 4 0 018 0zM12 18H8a2 2 0 00-2 2v1">
                            </path>
                        </svg>
                        Add Student
                    </a>
                    <a href="manage_students.php"
                        ...
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                            xmlns="http://www.w3.org/2000/svg">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M17 20h5m-5 0a2 2 0 100-4m0 4a2 2 0 110-4m-9-2h.01M7 12h.01M7 16h.01M4 20h4l-2 2h-2zm-3-4a2 2 0 012-2h12a2 2 0 012 2v2a2 2 0 01-2 2H3a2 2 0 01-2-2v-2z">
                            </path>
                        </svg>
                        Manage Students
                    </a>
                    ...
                    <p class="text-xs font-semibold text-gray-400 pt-3 pb-1 uppercase tracking-wider">Content & Media
                    </p>
                    ...
                    <a href="manage_success_stories.php"
                        class="flex items-center p-3 text-sm font-medium rounded-lg text-gray-300 hover:bg-slate-700 hover:text-white transition duration-150">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                            xmlns="http://www.w3.org/2000/svg">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <p class="text-xs font-semibold text-gray-400 pt-3 pb-1 uppercase tracking-wider">Feedbacks</p>
                    ...
                    <a href="../lib/logout.php"
                        class="flex items-center p-3 text-sm font-medium rounded-lg text-red-400 hover:bg-slate-700 hover:text-red-300 transition duration-150 mt-8 !pt-6">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                            xmlns="http://www.w3.org/2000/svg">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <label for="sidebar-toggle" class="fixed inset-0 bg-black opacity-50 z-30 hidden lg:hidden"
            id="sidebar-backdrop"></label>
    </div>
