...
<h1 class="text-3xl md:text-4xl font-extrabold text-primary-blue leading-tight tracking-tight">
                ...
                <div class="bg-white p-6 md:p-8 rounded-2xl shadow-lg border border-gray-200">
                    <h3 class="text-2xl font-bold text-gray-900 mb-5 border-b border-gray-200 pb-3 tracking-tight">Unit Details</h3>
                    <div class="space-y-4">
            ...
            <!-- ========================================= -->
                ...
                <!--    </h1>-->
                    ...
                    <div class="bg-blue-50 p-4 rounded-lg border border-blue-200">
                        ...
                        <p class="text-3xl font-extrabold text-blue-800">LKR. 
                    ...
                    <div>
                        ...
                        <p class="text-lg text-gray-700">
                            <?php if($course['course_duration']>24){ ?>
                             <?php echo htmlspecialchars($course['course_duration']); ?> Hrs (<?php echo htmlspecialchars($course['course_type']); ?>)
                        <?php }else{ ?>
            ...
            </div> </div> <?php else: // --- If no course was found --- ?>
