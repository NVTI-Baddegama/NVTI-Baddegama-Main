...
<div class="conatainer flex justify-center py-10 md:py-16">
    <div class="w-full max-w-3xl bg-white shadow-2xl rounded-xl p-8 md:p-10 border border-gray-100">
        ...
        <div id="successMessage"
            class="hidden bg-green-100 border-l-4 border-green-500 text-green-700 p-4 rounded-lg mb-6" role="alert">
            <p class="font-bold">Application Received!</p>
            <p>Your details have been submitted. We will contact you shortly. (Note: This message will not automatically
                appear without JavaScript.)</p>
        </div>
        ...
        <form id="registrationForm" class="space-y-8" action="../lib/registerbacend.php" method="POST">
            <fieldset class="border-t border-gray-200 pt-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        <label for="nic" class="block text-sm font-medium text-gray-700 mb-1">NIC (National Identity
                            Card)</label>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                    <div>
                        <label for="address" class="block text-sm font-medium text-gray-700 mb-1">Permanent
                            Address</label>
            ...
            <fieldset class="border-t border-gray-200 pt-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        <label for="contactNo" class="block text-sm font-medium text-gray-700 mb-1">Contact No
                            (Required)</label>
                        <input type="tel" id="contactNo" name="contactNo" required placeholder="07XXXXXXXX"
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 transition duration-150">
                    </div>
                    <div>
                        <label for="whatsappNo" class="block text-sm font-medium text-gray-700 mb-1">WhatsApp No
                            (Optional)</label>
            ...
            <fieldset class="border-t border-gray-200 pt-6">
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <div class="flex items-center">
                            <input id="olPassNo" name="olPassStatus" type="radio" value="No"
                                class="h-4 w-4 text-blue-600 border-gray-300 focus:ring-blue-500">
                            <label for="olPassNo" class="ml-2 text-sm font-medium text-gray-700">No (Awaiting
                                Results/Other)</label>
                        </div>
                    </div>
                </div>
                ...
                <div id="olSubjectsContainer" class="p-4 border border-gray-200 rounded-lg bg-gray-50 hidden">
                    <p class="text-sm font-medium text-gray-700 mb-3">If passed O/L, please provide grades for key
                        subjects:</p>
                    <div class="grid grid-cols-3 gap-4">
                        ...
                        <div>
                            <label for="olMaths"
                                class="block text-xs font-medium text-gray-600 mb-1">Mathematics</label>
                    ...
                    <div class="mt-6">
                        <label for="alCategory" class="block text-sm font-medium text-gray-700 mb-1">G.C.E. A/L
                            Stream/Category (Select one)</label>
            ...
            <fieldset class="border-t border-gray-200 pt-6">
                ...
                <div>
                    <label for="courseOptionOne" class="block text-sm font-medium text-gray-700 mb-1">Apply Course
                        (Option One - Primary Choice)</label>
                ...
                <div class="mt-6">
                    <label for="courseOptionTwo" class="block text-sm font-medium text-gray-700 mb-1">Apply Course
                        (Option Two - Secondary Choice)</label>
