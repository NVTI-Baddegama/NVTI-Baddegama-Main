        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div class="lg:col-span-1">
                ...
                <p class="text-gray-300 mb-4 text-sm">
                    National Vocational Training Institute Baddegama - Providing quality vocational education and skill
                    development for a better future.
                </p>
                <div class="flex space-x-4">
                    <a href="https://web.facebook.com/nvtibaddegamas/?_rdc=1&_rdr#" class="text-gray-300 hover:text-white transition duration-300">
                ...
                <div>
                    <img src="../images/software_developer_logo.png" alt="software_developer_logo"
                    class="w-[150px] mt-5 mb-5 flex justify-center items-center mt-0 mx-auto"
                    >
                    <p class="text-sm text-gray-300" >Analyze users' needs and then design and develop software to meet those needs</p>
                
                    <div class="flex  space-x-4 mt-5">
                        <a href="https://web.facebook.com/SoftwareDeveloperNVTI/?_rdc=1&_rdr#" class="text-gray-300 hover:text-white transition duration-300">
                        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                            <path fill-rule="evenodd"
                                d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z"
                                clip-rule="evenodd" />
            ...
            <div>
                ...
                <!-- <ul class="space-y-2">
                    ...
                    <li><a href="#" class="text-gray-300 hover:text-white transition duration-300 text-sm">Technical
                            Courses</a></li>
                    <li><a href="#" class="text-gray-300 hover:text-white transition duration-300 text-sm">Skill
                            Development</a></li>
...
<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d495.8393481400522!2d80.18204207813676!3d6.168933408944948!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3ae179c97c93dd53%3A0xf123b50754e29740!2sSoftware%20developer%20section!5e0!3m2!1sen!2slk!4v1761812336484!5m2!1sen!2slk" width="280" height="200" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>                    

            </div>

            <!-- Column 4: Contact Info -->
            <div>
                <h3 class="text-lg font-semibold mb-4 text-white border-b-2 border-primary pb-2">Contact Info</h3>
                <div class="space-y-3">
                    <div class="flex items-start">
                        <svg class="w-5 h-5 text-primary mt-0.5 mr-3 flex-shrink-0" fill="none" stroke="currentColor"
                            viewBox="0 0 24 24">
                    ...
                    <div class="flex items-center">
                        ...
                        <span class="text-gray-300 text-sm">+94 91 229 3119</span>
                    </div>
                    <div class="flex items-center">
                        <svg class="w-5 h-5 text-primary mr-3 flex-shrink-0" fill="none" stroke="currentColor"
                            viewBox="0 0 24 24">
